<?php
    ...
    $exists = $mysqli->query("select 1 from database.genres");
    if($exists === FALSE)
    {
    ...
    $exists = $mysqli->query("select 1 from database.tags");
    if($exists === FALSE)
    {
    ...
    $exists = $mysqli->query("select 1 from database.ratings");
    if($exists === FALSE)
    { 
    ...
    $exists = $mysqli->query("select 1 from database.links");
    if($exists === FALSE)
    {
    ...
    $exists = $mysqli->query("select 1 from database.movieId_genreId");
    if($exists === FALSE)
    {
    ...
    $exists = $mysqli->query("select 1 from database.movies");
    if($exists === FALSE)
    {
    ...
    $exists = $mysqli->query("select 1 from database.personality_types");
    if($exists === FALSE)
    {
    ...
    $exists = $mysqli->query("select 1 from database.personality_ratings");
    if($exists === FALSE)
    {
    ...
    $exists = $mysqli->query("select 1 from database.ratings_hashed");
    if($exists === FALSE)
    {
